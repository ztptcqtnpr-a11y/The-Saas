          ...
          {foundCustomer && (
            <div className="bg-green-50 border border-green-100 rounded-lg px-3 py-2 text-sm">
              ...
              {plan !== "starter" && loyaltyRule && foundCustomer.loyalty_points >= loyaltyRule.redeem_points_required && (
                <button onClick={redeem} className="mt-2 text-xs bg-green-700 text-white rounded-lg px-3 py-1.5">
                  Redeem {loyaltyRule.redeem_points_required} pts → {loyaltyRule.redeem_reward_name}
                </button>
              )}
